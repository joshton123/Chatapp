...
import { ADD_AUDIO_ROUTES } from "@/utils/ApiRoutes";
...
function CaptureAudio({ hide }) {
  ...
  const sendRecording = async () => {
    try {
      ...
      const response = await axios.post(ADD_AUDIO_ROUTES, formData, {
        headers: {
  ...
  useEffect(() => {
    if (waveform) {
      // Attach event listeners for keyboard keys
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      ...
      <div className="py-2 mx-4 px-4 text-white text-lg flex gap-3 justify-center items-center bg-search-input-container-background rounded-full drop-shadow-xl">
        {isRecording ? (
